...
public class RouteController {
	...
	public ResponseEntity<Route> deleteRoute(@PathVariable("id") int routeId) throws RouteNotFoundException{
	return new ResponseEntity<Route>(iRouteService.deleteRoute(routeId),HttpStatus.OK);

	}

	@GetMapping("view/{routeid}")
	public ResponseEntity<Route> getRouteById(@PathVariable("id") int routeId) throws RouteNotFoundException{
